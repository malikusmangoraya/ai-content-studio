...
Build an AI-powered content studio SaaS: blog writer, social captions, SEO meta generator, brand voice presets, team workspaces, and an AI chatbot. Monetization via subscription plans and credits.
...
| Layer    | Technology                                                                                                                    |
| -------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Frontend | Next.js 14 (App Router), TypeScript, Tailwind CSS, Shadcn UI, Tiptap Rich Text Editor, Framer Motion, Zustand                 |
| Backend  | Node.js With Next.js API Routes, Vercel AI SDK, LangChain, BullMQ (Redis Job Queue For Long Running AI Tasks)                 |
| Database | PostgreSQL (Supabase/Prisma ORM), Redis (Caching & Rate Limiting), Pgvector (Vector Embeddings For Brand Voice & RAG Chatbot) |
